            ...
            <div className="w-full py-16 sm:py-24">
                <Container>
                    <div className="mx-auto max-w-4xl overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-slate-900/70 p-8 text-center shadow-2xl shadow-cyan-500/10 sm:p-14">
                        {authStatus ? (
                            <>
                                <p className="mb-4 text-sm font-bold uppercase tracking-[0.3em] text-cyan-300">No posts yet</p>
                                <h1 className="text-4xl font-black tracking-tight text-white sm:text-6xl">
                                    No blogs written yet.
                                </h1>
                                <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                                    Be the first writer to share a story, tutorial, or idea with your readers.
                                </p>
                                <div className="mt-9 flex justify-center">
                                    <Link to="/add-post" className="rounded-full bg-cyan-300 px-7 py-3 font-black text-slate-950 shadow-lg shadow-cyan-400/20 transition hover:-translate-y-0.5 hover:bg-cyan-200">
                            ...
                            <>
                                <p className="mb-4 text-sm font-bold uppercase tracking-[0.3em] text-cyan-300">Your blogging space</p>
                                <h1 className="text-4xl font-black tracking-tight text-white sm:text-6xl">
                ...
                <section className='mb-12 overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-900/70 p-8 shadow-2xl shadow-violet-500/10 sm:p-12'>
                    ...
                    <div className='mt-4 grid gap-6 lg:grid-cols-[1.3fr_0.7fr] lg:items-end'>
                        <div>
                            ...
                            <p className='mt-5 max-w-2xl text-lg leading-8 text-slate-300'>Discover the latest posts, thoughtful articles, and creative ideas shared by our writers.</p>
                        </div>
